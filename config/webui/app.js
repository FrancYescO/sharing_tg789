!(function(e) {
  ...
  function(e, t, n) {
    ...
    t.a = o.a
      ...
      .constant("$authconf", {
        host: location.protocol.startsWith("http") ? location.hostname : "dsldevice",
        path: "/jsonrpc",
        port: 6800,
        encrypt: !1,
        auth: {},
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.nl_NL = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Voer de IP of DNS naam van de server waarop de RPC van Aria2 loopt (standaard: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.zh_CN = {
        ...
        "Enter the host": "主机",
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "输入 Aria2 RPC 所在服务器的 IP 或域名（默认：dsldevice）",
        "Enter the port": "端口",
        "Enter the port of the server on which the RPC for Aria2 is running (default: 6800)":
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.zh_TW = {
        ...
        "Enter the host": "主機",
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "輸入 Aria2 RPC 所在伺服器的 IP 或域名（預設：dsldevice）",
        "Enter the port": "埠號",
        "Enter the port of the server on which the RPC for Aria2 is running (default: 6800)":
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.pl_PL = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Wprowadź IP lub nazwę DNS serwera, na którym jest uruchomiona Aria2 z RPC (domyślnie: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.fr_FR = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Entrer l'IP ou le nom DNS du serveur sur lequel est lancé le RPC pour Aria2 (défaut : dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.de_DE = {
        ...
        "Enter the host": "Host",
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Gib die IP oder den DNS Namen des Servers ein, auf dem Aria2 läuft und mit dem du eine RPC-Verbindung etablieren willst (Standard: dsldevice)",
        "Enter the port": "Port",
        "Enter the port of the server on which the RPC for Aria2 is running (default: 6800)":
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.es_ES = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Escriba la dirección o nombre DNS del servidor Aria2 (por defecto: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.ru_RU = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Укажите IP или DNS-имя сервера, на котором запущена Aria2 со включенным RPC (по умолчанию: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.it_IT = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Inserisci l'IP o il nome DNS del server dov'è in esecuzione l'RPC per Aria2 (default: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.tr_TR = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Aria2 için RPC'nin çalıştığı sunucunun IP veya DNS adını girin (varsayılan: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.cs_CZ = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Zadejte IP nebo DNS jméno serveru na kterém běží Aria2 RPC (výchozí: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.fa_IR = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "نام IP یا DNS سرور که RPC برای Aria2 در حال اجرا است را وارد کنید (به طور پیش فرض: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.id_ID = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Masukkan IP atau nama DNS peladen tempat RPC Aria2 berjalan (asali: dsldevice)",
  ...
  function(e, t) {
    "undefined" == typeof translations && (translations = {}),
      (translations.pt_BR = {
        ...
        "Enter the IP or DNS name of the server on which the RPC for Aria2 is running (default: dsldevice)":
          "Informe o IP ou nome DNS do servidor no qual o RPC do Aria2 está rodando (default: dsldevice)",
